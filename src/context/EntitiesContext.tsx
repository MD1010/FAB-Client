...
import { LEAGUES_ENDPOINT, NATIONS_ENDPOINT, TEAMS_ENDPOINT } from "src/consts/endpoints";
...
const EntitiesContextProvider: FC = (props) => {
    const [entities, setEntities] = useState({ nations: [], teams: [], leagues: [] });
    ...
    return (
        <EntitiesContext.Provider value={{nations: entities.nations, teams: entities.teams, leagues: entities.leagues}}>
            { props.children }
