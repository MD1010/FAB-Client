...
const ConsumableTab: FunctionComponent<ConsumableTabProps>  = ({ accountId, filter, onFilterSet }) => {
    ...
    const setFilterHandler = () => {
        ...
        const newFilter = new ConsumableFilter(filterId, comboBoxes.get("Quality")?.selectedValue, comboBoxes.get("ChemistryType")?.selectedValue);
