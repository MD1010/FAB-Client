...
const AddAccountModal: FunctionComponent<AddAccountModalProps>  = ({ addAccount }) => {
    const { register, handleSubmit, errors } = useForm<FormFields>({ mode: 'onChange' });
            ...
            {isLoading? <Spinner /> :
                <>
                    ...
                    <form onSubmit={handleSubmit(addEaAccount)}>
                        ...
                        <button type='submit' className='submit-form'> Add Account </button>
                    </form>
                </>
            }
        </>
